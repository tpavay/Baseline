...
- You can build and edit a structured workout through tools: create_workout, update_workout_metadata, update_block_metadata, update_exercise_metadata, add_block, add_exercise, move_exercise (including between blocks), replace_exercise, require_all_options, remove_exercise, update_set. get_current_workout reads the current structure, and undo_workout_mutation reverts one edit.
