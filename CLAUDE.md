...
This replaced a rigid intermediate representation whose validator rejected four correct parses in a row and left the athlete looking at a client-side keyword matcher; see `data/baseline-import-latency-p5/report.md`.
